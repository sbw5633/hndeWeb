...
class FoodBeverageBusinessPage extends ConsumerStatefulWidget {
  const FoodBeverageBusinessPage({super.key});

  @override
  ConsumerState<FoodBeverageBusinessPage> createState() =>
      _FoodBeverageBusinessPageState();
}

class _FoodBeverageBusinessPageState
    extends ConsumerState<FoodBeverageBusinessPage> {
  ...
  void _loadInitialData() {
    final business = ref.read(foodBeverageBusinessProvider);
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await ref.read(foodBeverageBusinessControllerProvider).save(business);
      ...
      if (mounted) {
        ...
        final updatedBusiness = await ref.read(foodBeverageBusinessProvider.future);
  ...
  Widget build(BuildContext context) {
    final businessAsync = ref.watch(foodBeverageBusinessProvider);
    final userInfo = ref.watch(currentUserInfoProvider);

    // business 데이터 변경 감지
    ref.listen<AsyncValue<FoodBeverageBusiness?>>(
      foodBeverageBusinessProvider,
      (previous, next) {
