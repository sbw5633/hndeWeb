...
class Recruitment {
  ...
  final RecruitmentSection? jobOpenings;
  final RecruitmentSection? applicationMethod;
  final RecruitmentSection? process;
  ...
  Map<String, dynamic> toFirestore() {
    return {
      'topImageUrl': topImageUrl,
      'jobOpenings': jobOpenings?.toFirestore(),
      'applicationMethod': applicationMethod?.toFirestore(),
      'process': process?.toFirestore(),
    };
  }
}
