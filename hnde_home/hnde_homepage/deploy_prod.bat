@echo off
REM hnde_homepage Firebase 호스팅 배포 스크립트 (Windows, PROD)
...
echo 🔥 Firebase 호스팅 배포 중 (prod, target=homepage)...
firebase deploy --project hnde-homepage-prod --only hosting:homepage
